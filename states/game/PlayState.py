...
from src.states.entity.player.PlayerLiftPotState import PlayerLiftPotState
from src.states.entity.player.PlayerThrowPotState import PlayerThrowPotState
from src.states.entity.player.PlayerWalkPotState import PlayerWalkPotState
# from src.states.entity.
...
class PlayState(BaseState):
    ...
    def Enter(self, params):
        ...
        self.player.state_machine.SetStates({
            ...
            'lift_pot' : PlayerLiftPotState(self.player,self.dungeon),
            'throw_pot' : PlayerThrowPotState(self.player,self.dungeon),
            'walk_pot' : PlayerWalkPotState(self.player,self.dungeon)
